                                ...
                                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="margin-bottom: 15px;">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="item active">
                                            <img src="../../Files/img/slider/slider-1.jpg" alt="...">
                                            <div class="carousel-caption">
                                                <!-- Texto descripcion aqui -->
                                            </div>
                                        </div>
                                        <div class="item">
                                            <img src="../../Files/img/slider/slider-2.jpg" alt="...">
                                            <div class="carousel-caption">
                                                <!-- Texto descripcion aqui -->
                                            </div>
                                        </div>
                                        <div class="item">
                                            <img src="../../Files/img/slider/slider-3.jpg" alt="...">
                                            <div class="carousel-caption">
                                                <!-- Texto descripcion aqui -->
                                            </div>
                                        </div>
                                        <div class="item">
                                            <img src="../../Files/img/slider/slider-4.jpg" alt="...">
                                            <div class="carousel-caption">
                                                <!-- Texto descripcion aqui -->
                                            </div>
                                        </div>
