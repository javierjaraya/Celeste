...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <br>
            <table class="table">
                <tr><td class="td-borde fondo alto-xs" colspan="4" style = "text-align: right">Total Ventas del Mes:</td><td class="td-borde ancho-69mm center"><?= "$ ".$totalVentasDelDia ?></td></tr>
            </table>
        </div>
    </body>
</html>
