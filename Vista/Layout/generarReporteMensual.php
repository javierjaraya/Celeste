...
$fechaFormateada = utf8_decode(htmlspecialchars($_REQUEST['fechaFormateada']));
$ventasDiarias = $control->getVentasPorMes($fechaReporte);
?>
...
<html>
    ...
    <body>
        ...
        <div>            
            <table class="table">                    
                <tr><th align="center"><h3>REPORTE<br>VENTAS <?= $fechaFormateada ?></h3></th></tr>
            </table>
        </div>
        <div>
            <table class="table">
        ...
        <div>
            <table class="table">
                <tr><td class="td-borde alto-xm ancho-71mm" colspan="8">DETALLE DE VENTAS DEL MES DE <?= $fechaFormateada ?></td></tr> 
                <tr>
                ...
                foreach ($ventasDiarias as $venta) {
                    ...
                    $totalVentasDelMes = $totalVentasDelMes + $montoTotalCompra;
                }
                if ($count == 0) {
...
//                }
            ...
            <br>
            <table class="table">
                <tr><td class="td-borde fondo alto-xs" colspan="4" style = "text-align: right">Total Ventas del Mes:</td><td class="td-borde ancho-69mm center"><?= "$ " . $totalVentasDelMes ?></td></tr>
            </table>
        </div>
    </body>
</html>
